      ...
      <div className="flex min-h-screen">
        ...
        <div className="flex min-h-screen min-w-0 flex-1 flex-col">
          <header className="sticky top-0 z-30 border-b border-border bg-background/90 backdrop-blur supports-[backdrop-filter]:bg-background/70">
            <div className="flex min-h-[68px] items-center justify-between gap-3 px-3 sm:px-4 lg:px-6 xl:px-8">
              ...
              <div className="hidden items-center gap-2 md:flex lg:gap-3">
                ...
                >
                  ...
                  <input
                    ...
                    className="w-36 bg-transparent text-sm text-foreground outline-none placeholder:text-muted-foreground lg:w-56 xl:w-64"
                  />
                  {query && (
                    <button
                      type="button"
                  ...
                  <button
                    type="submit"
                    className="rounded-xl bg-primary px-3 py-1.5 text-xs font-medium text-primary-foreground transition hover:opacity-90"
                  >
                    Search
                  </button>
                </form>
            ...
            <div className="border-t border-border px-3 py-3 md:hidden">
              <form onSubmit={handleSearchSubmit} className="flex items-center gap-2">
                <div className="flex min-w-0 flex-1 items-center gap-2 rounded-2xl border border-border bg-card px-3 py-2.5">
                  <Search className="h-4 w-4 text-muted-foreground" />
                  <input
                    type="text"
                    placeholder="Search students..."
                ...
                <button
                  type="submit"
                  className="rounded-2xl bg-primary px-4 py-2.5 text-sm font-medium text-primary-foreground transition hover:opacity-90"
                >
                  Search
                </button>
              </form>
          ...
          <main className="flex-1 px-3 py-3 sm:px-4 sm:py-4 lg:px-6 lg:py-6 xl:px-8">
